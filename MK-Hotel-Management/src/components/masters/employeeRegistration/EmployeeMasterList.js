...
const EmployeeMasterList = () => {
    ...
    const handleClickOpenPopupAdd = (info) => {
        setInfo(undefined);
        setOpenPopup(true);
    ...
    return (
        <>
                    ...
                    <Table size="small" stickyHeader>
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell align="center" className={`${styles.table_head}`} onClick={() => HandleSort('employee_type', sortBy, setSortBy, rows)}>Employee type <span className={`${styles.sort_icon}`}> {sortBy === 'employee_type' ? '▲' : '▼'} </span></StyledTableCell>
                                <StyledTableCell align="center" className={`${styles.table_head}`} onClick={() => HandleSort('employee_name', sortBy, setSortBy, rows)}>Employee name <span className={`${styles.sort_icon}`}> {sortBy === 'employee_name' ? '▲' : '▼'} </span></StyledTableCell>
                                <StyledTableCell align="center" className={`${styles.table_head}`} onClick={() => HandleSort('employee_contact_no', sortBy, setSortBy, rows)}>Contact No <span className={`${styles.sort_icon}`}> {sortBy === 'employee_contact_no' ? '▲' : '▼'} </span></StyledTableCell>
                                <StyledTableCell align="center" className={`${styles.table_head}`} onClick={() => HandleSort('employee_address', sortBy, setSortBy, rows)}>Address <span className={`${styles.sort_icon}`}> {sortBy === 'employee_address' ? '▲' : '▼'} </span></StyledTableCell>
                                <StyledTableCell align="center" className={`${styles.table_head}`} onClick={() => HandleSort('employee_id_card', sortBy, setSortBy, rows)}>Id Card <span className={`${styles.sort_icon}`}> {sortBy === 'employee_id_card' ? '▲' : '▼'} </span></StyledTableCell>
                                <StyledTableCell align="center" className={`${styles.table_head}`} onClick={() => HandleSort('status', sortBy, setSortBy, rows)}>Status <span className={`${styles.sort_icon}`}> {sortBy === 'status' ? '▲' : '▼'} </span></StyledTableCell>
                            </StyledTableRow>
                        </TableHead>
                        <TableBody>
                            {rows && search(rows)
            ...
            <DeleteDialog
                ...
                displayName={deleteInfo?.employee_name || ''}
            />
            <BootstrapDialog
                PaperProps={{
                    sx: {
